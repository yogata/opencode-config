...
- `docs/requirements/REQ-{NNNN}-{slug}.md`（要件定義の個別ファイル）
...
5. 要件docを `docs/requirements/REQ-{NNNN}-{slug}.md` に保存:
   - REQ番号: `docs/requirements/` 内の最大REQ番号 + 1
   - テンプレート: `templates/doc_requirement.md`
   - `docs/requirements/README.md` のインデックスに新規REQを追加
